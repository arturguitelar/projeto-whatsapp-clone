...
export class Message extends Model {
    ...
    /**
     * Envia um documento de um usuário especificado.
     * @param { String } chatId ID do chat. "Para onde".
     * @param {*} from Quem está enviando. "De onde".
     * @param { String } file Documento a ser enviado.
     * @param {*} preview Preview do documento.
     * @param {*} info Informação do documento.
     * @return { Promise } Preview do arquivo enviado.
     */
     ...
     * @param {*} metadata Metadados do áudio.
     * @param {*} photo Imagem do user atual.
     * @return { Promise } Áudio enviada.
     */
     ...
     * @param { Boolean } me Dono da mensagem. Default = true.
     * @return { HTMLDivElement } Div com a view da mensagem.
     */
    getViewElement(me = true) {
        ...
        switch (this.type) {
            ...
            case 'audio':
                ...
                // pegando os elementos gráficos de áudio
                ...
                // manipulando os eventos do player de áudio
                ...
                // manipulando os elementos visuais do player de áudio
        ...
        // verificado se a mensagem é do tipo "enviada" ou "recebida"
    ...
    /**
     * Retorna um elemento com o ícone de status.
     * - Tipos de status: wait, sent, received e read.
     * @return { HTMLDivElement } Div com ícone de status. 
     */
